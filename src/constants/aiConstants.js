export const DEFAULT_AI_PROMPTS = {
  ...
  randomJoke: "Gere uma piada curta e engraçada, no estilo 'tiozão' ou de humor seco. Preferencialmente no formato de pergunta e resposta, com a resposta sendo engraçada ou surpreendente. Observe as piadas existentes como referência para entender o estilo de humor do grupo, mas crie uma piada original que não esteja na lista. PIADAS EXISTENTES: {EXISTING_JOKES}",
